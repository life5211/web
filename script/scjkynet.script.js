// 获取所有课程列表
(async function () {
  let authorization = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cNUDZhGcTTVXvP6ZWeGumy8Lf8OB7HWWHdcccXwR-FE";
  ...
  return (await fetch(`${api}&pageSize=500&pageNo=3`, {headers: {authorization}})).json()
      .then(r => r.data.data.resResourceList.map(e => ({id: e.id, name: e.name, crt: new Date(e.createTime).toISOString()})));
})();
