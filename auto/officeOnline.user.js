...
(function () {
  "use strict";
  const fileTypes2312 = (
    "doc,docx,wps,odt,rtf,xls,xlsx,et,ods,csv,ppt,pptx,dps,odp,pdf,ofd,txt,jpg,jpeg,gif,png,bmp,tif,tiff," +
    "mp3,m4a,mid,midi,wma,mp4,mov,zip,rar,tar,7z,dwg,dxf,dwf,xml,js,css,java,cpp,cs,sql,bat,json,conf"
  ).split(",");
    ...
    (_) =>
      document.querySelectorAll("a").forEach((aTag) => {
        ...
        if (fileTypes2312.includes(aTag.href.match(/\.([^.]+)$/)[1]))
          return nodeCloneWeb2312(aTag, aTag.href);
        if (aTag.innerText && aTag.innerText.startsWith("附件"))
          return nodeCloneWeb2312(aTag, aTag.href);
      }),
    500
  );
